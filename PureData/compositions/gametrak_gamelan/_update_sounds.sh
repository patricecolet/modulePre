...
for filename in *.wav; do
	...
	newSound=son${newNumberSound}.wav

	echo sshpass -praspberry scp ./${bar} pi@192.168.1.${newNumberRasp}:$_NAMESPACE/PureData/gametrak_gamelan/${newSound}
	sshpass -praspberry scp ./${bar} pi@192.168.1.${newNumberRasp}:$_NAMESPACE/PureData/gametrak_gamelan/${newSound}
done

# sshpass -praspberry scp ./${bar} pi@192.168.1.${newNumberRasp}:/home/patch/modulePre/PureData/track_1/${newSound}
